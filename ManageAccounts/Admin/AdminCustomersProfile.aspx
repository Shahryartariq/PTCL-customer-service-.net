<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanelMasterPage.Master" AutoEventWireup="true" CodeBehind="AdminCustomersProfile.aspx.cs" Inherits="PtclCustomerService.ManageAccounts.Admin.AdminCustomersProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <h3 class="text-center my-3 text-success ">Customers Profile</h3>
        <div class="container">
            <div class="main-body">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <asp:Panel runat="server" ID="PanelStatus" Text="" CssClass="text-muted font-size-sm"></asp:Panel>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <asp:Panel runat="server" ID="PanelTotalC"></asp:Panel>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Active Complaints</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <asp:Panel runat="server" ID="PanelActiveC"></asp:Panel>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <asp:HyperLink runat="server" ID="HypEditProfile" CssClass="btn btn-primary " Text="EditProfile"></asp:HyperLink>
                                        <asp:HyperLink runat="server" ID="HypBack" CssClass="btn btn-primary " Text="Cancel"></asp:HyperLink>
                                    </div>
                                </div>
                            </div>
                        </div>

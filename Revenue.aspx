<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanelMasterPage.Master" AutoEventWireup="true" CodeBehind="Revenue.aspx.cs" Inherits="PtclCustomerService.Revenue" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 card">
                ...
                <a class="btn btn-primary w-50 m-auto my-3 active" href="Revenue.aspx">Revenue</a>
            ...
            <div class="col-lg-9 card">
                <div class="row">
                    ...
                    <h3 class="text-center my-3 text-success ">Revenue</h3>
